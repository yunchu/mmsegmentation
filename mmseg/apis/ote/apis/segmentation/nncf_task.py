...
class OTESegmentationNNCFTask(OTESegmentationInferenceTask, IOptimizationTask):
    ...
    def optimize(
        ...
        print(f"!!!self._optimization_type in nncf_task = {self._optimization_type}")
        print(f"!!!output_model.optimization_type in nncf_task = {output_model.optimization_type}")
